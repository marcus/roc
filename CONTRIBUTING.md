...
- When editing consumer docs, keep the React caveat explicit: the published React outputs are `.jsx` files for JSX-aware bundlers and frameworks, and only `@marcus/roc/react/index.js` currently ships bundled declarations
