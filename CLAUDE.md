...
| Import paths (React barrel) | `@marcus/roc/react/{style}/index.js` | `import { ArrowLeft } from '@marcus/roc/react/outline/index.js'` |
| Import paths (Svelte style barrel) | `@marcus/roc/svelte/{style}` | `import { ArrowLeft } from '@marcus/roc/svelte/outline'` |
| Import paths (Svelte component) | `@marcus/roc/svelte/{style}/{Icon}.svelte` | `import ArrowLeft from '@marcus/roc/svelte/outline/ArrowLeft.svelte'` |
...
| `npm run dev` | Watch mode -- rebuilds on changes to `src/svg/`, `src/icons.json`, and `demo/src/` |
