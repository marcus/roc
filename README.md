...
The hook normalizes only the subject line by trimming extra whitespace, converting common `feat:`/`fix:`/`docs:` prefixes to sentence style, capitalizing the leading word, and removing a trailing `.` or `!`.
